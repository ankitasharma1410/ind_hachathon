...
class SepaTransferDocumentBuilder2 extends SepaXmlDocumentBuilder {
	...
	public static String toXml(SepaTransferDocumentData source, String[] row) throws DatatypeConfigurationException, IOException {
		...
		for (PaymentInstruction16 payment : transferData.getPmtInf()) {
			...
			genericAccountIdentification1.setId(row[5]);
		...
		FileUtils.writeStringToFile(new File("D:\\ING_Info\\ING_Repository\\com.hackathon1.demo\\output\\" + Calendar.getInstance().getTimeInMillis()),
